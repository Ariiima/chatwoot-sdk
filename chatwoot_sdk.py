...
class ChatwootSDK:
    ...
    def _send_request(self, method, endpoint, data=None, json=None, params=None):
        ...
        response = requests.request(method, url, headers=self.headers, data=data, json=json, params=params)
    ...
    class Conversations:
        ...
        def list(self, inbox_identifier, contact_identifier):
            return self.client_send_request('GET', f'/public/api/v1/inboxes/{inbox_identifier}/contacts/{contact_identifier}/conversations')
